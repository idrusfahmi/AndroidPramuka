...
public class AdapterSiswa extends RecyclerView.Adapter<AdapterSiswa.MyViewHolder> {
    ...
    public AdapterSiswa(Context mContext, ArrayList<String> array_id_siswa, ArrayList<String> array_nama_siswa) {
        super();
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new AdapterSiswa.MyViewHolder(itemView);
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        holder.cv_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(mContext, Absensi.class);
                i.putExtras(bundle);
                ((Siswa) mContext).startActivityForResult(i, 2);
            }
        });
    }
